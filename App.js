...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="res-card" style={cardStyle}>
      <img className="res-logo" src={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/${resData.info.cloudinaryImageId}`} alt="Restaurant logo"/>
...
const resList = [
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-09-29 02:00:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-09-29 06:55:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-09-29 04:30:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-09-29 00:30:00",
        "opened": true
      },
      "badges": {
        "textExtendedBadges": [
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        ...
        {/* <RestaurantCard resName="Jaipur Roti Point" cuisines="Fast Food, Chinese, North Indian" rating="4.8 Stars" time="20 minutes"/>
        <RestaurantCard resName="Nagarjuna" cuisines="Biryani, South Indian, North Indian" rating="4.9 Stars" time="35 minutes"/> */}
      </div>
    </div>
  )
}
